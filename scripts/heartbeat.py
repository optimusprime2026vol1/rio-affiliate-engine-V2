...
validators, and sends Telegram only on health-state transitions (failure/recovery)
to avoid alert spam.
"""
...
jsave(ALERT_STATE,{"healthy":all_pass,"updated":now})
print("heartbeat done",json.dumps({"ok":all_pass,"counts":counts}))
