...
ROOT=os.path.join(os.path.dirname(__file__),"..");IST=timezone(timedelta(hours=5,minutes=30));STATE_PATH=os.path.join(ROOT,"data","telegram_chat_state.json");STATUS_PATH=os.path.join(ROOT,"data","status.json");CONTROL_PATH=os.path.join(ROOT,"data","control.json");SOUL_PATH=os.path.join(ROOT,"data","SOUL.md");CORE_PATH=os.path.join(ROOT,"data","RIO_3.0_DEFINITION.md");POLICY_PATH=os.path.join(ROOT,"data","AUTONOMY_POLICY.md");MAX_HISTORY=12;MAX_REPLY_CHARS=3500
